...
import Tools from "./components/StoryScreens/Tools";
import Quiz from "./components/StoryScreens/Quiz";
import Roadmap from "./components/StoryScreens//Roadmap";
      ...
      <div className="App">
        <Routes>
          <Route path="/" element={<LayoutsWithHeader />}>
            ...
            <Route exact path="/tools" element={<PrivateRoute />}>
              <Route exact path="/tools" element={<Tools />} />
            </Route>

            <Route exact path="/roadmap" element={<PrivateRoute />}>
